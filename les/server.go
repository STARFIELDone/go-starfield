...
type LesServer struct {
	...
	archiveMode bool // Flag whether the EvolutionStellarToken node runs in archive mode.
...
func NewLesServer(node *node.Node, e *est.EvolutionStellarToken, config *est.Config) (*LesServer, error) {

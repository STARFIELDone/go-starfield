...
func (c *lesCommons) setupOracle(node *node.Node, genesis common.Hash, ethconfig *est.Config) *checkpointoracle.CheckpointOracle {
	...
	client := evolutionstellartoken.NewClient(rpcClient)
	oracle.Start(client)

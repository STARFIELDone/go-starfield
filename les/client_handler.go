...
type clientHandler struct {
	...
	backend    *LightEvolutionStellarToken
...
func newClientHandler(ulcServers []string, ulcFraction int, checkpoint *params.TrustedCheckpoint, backend *LightEvolutionStellarToken) *clientHandler {
...
func (h *clientHandler) handle(p *serverPeer) error {
	...
	if err := h.backend.peers.register(p); err != nil {
		p.Log().Error("Light EvolutionStellarToken peer registration failed", "err", err)
		return err
	}

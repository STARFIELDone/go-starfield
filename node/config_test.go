...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gest.ipc", false, filepath.Join(os.TempDir(), "gest.ipc")},
		{"data", "gest.ipc", false, "data/gest.ipc"},
		{"data", "./gest.ipc", false, "./gest.ipc"},
		{"data", "/gest.ipc", false, "/gest.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gest.ipc", true, `\\.\pipe\gest.ipc`},
		{"data", "gest.ipc", true, `\\.\pipe\gest.ipc`},
		{"data", `\\.\pipe\gest.ipc`, true, `\\.\pipe\gest.ipc`},
	}

...
/*
Package node sets up multi-protocol EvolutionStellarToken nodes.
...
Node also creates the shared store of encrypted EvolutionStellarToken account keys. Services can access

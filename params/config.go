...
var (
	...
	// and accepted by the EvolutionStellarToken core developers into the Ethash consensus.
	//
	...
	// and accepted by the EvolutionStellarToken core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/EvolutionStellarToken/EIPs/issues/150)
...
// CheckConfigForkOrder checks that we don't "skip" any forks, gest isn't pluggable enough

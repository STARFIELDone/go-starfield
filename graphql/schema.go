...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte EvolutionStellarToken address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an EvolutionStellarToken account at a particular block.
    type Account {
    ...
    # Log is an EvolutionStellarToken event log.
    type Log {
    ...
    # Transaction is an EvolutionStellarToken transaction.
    type Transaction {
    ...
    # Block is an EvolutionStellarToken block.
    type Block {
        ...
        # Account fetches an EvolutionStellarToken account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an EvolutionStellarToken account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an EvolutionStellarToken block by number or by hash. If neither is

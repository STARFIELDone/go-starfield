...
// Package graphql provides a GraphQL interface to EvolutionStellarToken node data.
package graphql
...
// Account represents an EvolutionStellarToken account at a particular block.
type Account struct {
...
// Transaction represents an EvolutionStellarToken transaction.
...
// Block represents an EvolutionStellarToken block.
...
type CallData struct {
	From     *common.Address // The EvolutionStellarToken address the call is from.
	To       *common.Address // The EvolutionStellarToken address the call is to.
...
type SyncState struct {
	progress EvolutionStellarToken.SyncProgress
}

...
func makeHeaderChain(parent *types.Header, n int, db estdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (estdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() estdb.Database {
	return odr.db
}

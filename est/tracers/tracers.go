...
import (
	...
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/est/tracers/internal/tracers"
)
...
// init retrieves the JavaScript transaction tracers included in go-EvolutionStellarToken.
func init() {

...
// Syncing provides information when this nodes starts synchronising with the EvolutionStellarToken network and when it's finished.
...
type SyncingResult struct {
	...
	Status  EvolutionStellarToken.SyncProgress `json:"status"`
}

...
// DefaultConfig contains default settings for use on the EvolutionStellarToken main net.
...
type Config struct {
	...
	// If nil, the EvolutionStellarToken main net block is used.
	...
	// RPCGasCap is the global gas cap for est-call variants.

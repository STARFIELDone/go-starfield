...
const protocolName = "est"

// ProtocolVersions are the supported versions of the est protocol (first is primary).
...
// statusData63 is the network packet for the status message for est/63.
...
// statusData is the network packet for the status message for est/64 and later.

...
// Package filters implements an EvolutionStellarToken filtering system for block,
...
type subscription struct {
	...
	typ       Type
	created   time.Time
	logsCrit  EvolutionStellarToken.FilterQuery
	logs      chan []*types.Log
...
func (es *EventSystem) SubscribeLogs(crit EvolutionStellarToken.FilterQuery, logs chan []*types.Log) (*Subscription, error) {
...
func (es *EventSystem) subscribeMinedPendingLogs(crit EvolutionStellarToken.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribeLogs(crit EvolutionStellarToken.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribePendingLogs(crit EvolutionStellarToken.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),

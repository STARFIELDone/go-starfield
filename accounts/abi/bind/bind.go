...
// Package bind generates EvolutionStellarToken contract Go bindings.
//
// Detailed usage document and tutorial available on the go-EvolutionStellarToken Wiki page:
// https://github.com/EvolutionStellarToken/go-EvolutionStellarToken/wiki/Native-DApps:-Go-bindings-to-EvolutionStellarToken-contracts
package bind

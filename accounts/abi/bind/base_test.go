...
func (mc *mockCaller) CallContract(ctx context.Context, call EvolutionStellarToken.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call EvolutionStellarToken.CallMsg) ([]byte, error) {

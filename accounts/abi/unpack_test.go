...
func TestMultiReturnWithStringArray(t *testing.T) {
	...
	ret3, ret3Exp := new([2]string), [2]string{"EvolutionStellarToken", "Hello, EvolutionStellarToken!"}
...
func TestMultiReturnWithStringSlice(t *testing.T) {
	...
	ret1, ret1Exp := new([]string), []string{"EvolutionStellarToken", "go-EvolutionStellarToken"}

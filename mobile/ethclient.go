...
// EvolutionStellarTokenClient provides access to the EvolutionStellarToken APIs.
type EvolutionStellarTokenClient struct {
	client *evolutionstellartoken.Client
}

// NewEvolutionStellarTokenClient connects a client to the given URL.
func NewEvolutionStellarTokenClient(rawurl string) (client *EvolutionStellarTokenClient, _ error) {
	rawClient, err := evolutionstellartoken.Dial(rawurl)
	return &EvolutionStellarTokenClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *EvolutionStellarTokenClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *EvolutionStellarTokenClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *EvolutionStellarTokenClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *EvolutionStellarTokenClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *EvolutionStellarTokenClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *EvolutionStellarTokenClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *EvolutionStellarTokenClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *EvolutionStellarTokenClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *EvolutionStellarTokenClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *EvolutionStellarTokenClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *EvolutionStellarTokenClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *EvolutionStellarTokenClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *EvolutionStellarTokenClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *EvolutionStellarTokenClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *EvolutionStellarTokenClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *EvolutionStellarTokenClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *EvolutionStellarTokenClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *EvolutionStellarTokenClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *EvolutionStellarTokenClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *EvolutionStellarTokenClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *EvolutionStellarTokenClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *EvolutionStellarTokenClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *EvolutionStellarTokenClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *EvolutionStellarTokenClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *EvolutionStellarTokenClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *EvolutionStellarTokenClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *EvolutionStellarTokenClient) SendTransaction(ctx *Context, tx *Transaction) error {

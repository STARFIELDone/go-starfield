...
import (
	...
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/crypto/blake2b"
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/crypto/bls12381"
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/crypto/bn256"
...
// PrecompiledContractsHomestead contains the default set of pre-compiled EvolutionStellarToken
...
// PrecompiledContractsByzantium contains the default set of pre-compiled EvolutionStellarToken
...
// PrecompiledContractsIstanbul contains the default set of pre-compiled EvolutionStellarToken
...
// PrecompiledContractsYoloV2 contains the default set of pre-compiled EvolutionStellarToken
...
func (c *bigModExp) RequiredGas(input []byte) uint64 {
	...
	if c.eip2565 {
		...
		// in EIP-2565 (https://eips.EvolutionStellarToken.org/EIPS/eip-2565):
		//
		// def mult_complexity(x):
		//    ceiling(x/8)^2
		//

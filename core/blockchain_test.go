...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (estdb.Database, *BlockChain, error) {
	var (
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	makeDb := func() (estdb.Database, func()) {
...
//
// https://github.com/EvolutionStellarToken/go-EvolutionStellarToken/pull/15941
...
//
// Details at:
//  - https://github.com/EvolutionStellarToken/go-EvolutionStellarToken/issues/18977
//  - https://github.com/EvolutionStellarToken/go-EvolutionStellarToken/pull/18988

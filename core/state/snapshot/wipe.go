...
func wipeSnapshot(db estdb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db estdb.KeyValueStore) error {
...
func wipeKeyRange(db estdb.KeyValueStore, kind string, prefix []byte, keylen int) error {

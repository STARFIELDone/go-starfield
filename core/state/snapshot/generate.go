...
func generateSnapshot(diskdb estdb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, wiper chan struct{}) *diskLayer {
...
func journalProgress(db estdb.KeyValueWriter, marker []byte, stats *generatorStats) {
...
func (dl *diskLayer) generate(stats *generatorStats) {
	...
	for accIt.Next() {
		...
		if batch.ValueSize() > estdb.IdealBatchSize || abort != nil {

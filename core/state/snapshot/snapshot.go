...
// SnapshotTree is an EvolutionStellarToken state snapshot tree. It consists of one persistent
...
type Tree struct {
	diskdb estdb.KeyValueStore      // Persistent database to store the snapshot
...
func New(diskdb estdb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, async bool, recovery bool) *Tree {

...
// Package state provides a caching layer atop the EvolutionStellarToken state trie.
package state
...
// StateDB structs within the EvolutionStellarToken protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/EvolutionStellarToken/go-EvolutionStellarToken/pull/16485#issuecomment-380438527),

...
// account array.
func checkStateAccounts(t *testing.T, db estdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db estdb.Database, root common.Hash) error {
...
func checkStateConsistency(db estdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(estdb.Database), srcRoot)

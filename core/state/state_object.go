...
// stateObject represents an EvolutionStellarToken account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of EvolutionStellarToken address of the account
	data     Account
	db       *StateDB
...
// Account is the EvolutionStellarToken consensus representation of accounts.

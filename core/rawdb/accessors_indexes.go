...
func ReadTxLookupEntry(db estdb.Reader, hash common.Hash) *uint64 {
...
func writeTxLookupEntry(db estdb.KeyValueWriter, hash common.Hash, numberBytes []byte) {
...
// a list of hashes
func WriteTxLookupEntries(db estdb.KeyValueWriter, number uint64, hashes []common.Hash) {
...
func WriteTxLookupEntriesByBlock(db estdb.KeyValueWriter, block *types.Block) {
...
func DeleteTxLookupEntry(db estdb.KeyValueWriter, hash common.Hash) {
...
func DeleteTxLookupEntries(db estdb.KeyValueWriter, hashes []common.Hash) {
	for _, hash := range hashes {
...
func ReadTransaction(db estdb.Reader, hash common.Hash) (*types.Transaction, common.Hash, uint64, uint64) {
...
// its added positional metadata.
func ReadReceipt(db estdb.Reader, hash common.Hash, config *params.ChainConfig) (*types.Receipt, common.Hash, uint64, uint64) {
...
func ReadBloomBits(db estdb.KeyValueReader, bit uint, section uint64, head common.Hash) ([]byte, error) {
	return db.Get(bloomBitsKey(bit, section, head))
}

// WriteBloomBits stores the compressed bloom bits vector belonging to the given
// section and bit index.
func WriteBloomBits(db estdb.KeyValueWriter, bit uint, section uint64, head common.Hash, bits []byte) {
...
func DeleteBloombits(db estdb.Database, bit uint, from uint64, to uint64) {

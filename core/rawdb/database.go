...
import (
	...
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/estdb/leveldb"
...
func NewDatabase(db estdb.KeyValueStore) estdb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db estdb.KeyValueStore, freezer string, namespace string) (estdb.Database, error) {
...
func NewMemoryDatabase() estdb.Database {
...
func NewMemoryDatabaseWithCap(size int) estdb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (estdb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (estdb.Database, error) {
...
func InspectDatabase(db estdb.Database) error {

...
func NewTable(db estdb.Database, prefix string) estdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) estdb.Iterator {
...
func (t *table) NewBatch() estdb.Batch {
...
func (b *tableBatch) Replay(w estdb.KeyValueWriter) error {

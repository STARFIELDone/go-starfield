...
// Package forkid implements EIP-2124 (https://eips.EvolutionStellarToken.org/EIPS/eip-2124).
package forkid
...
// NewID calculates the EvolutionStellarToken fork ID from the chain config, genesis hash, and head.

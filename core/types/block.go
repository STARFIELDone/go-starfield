...
// Package types contains data types related to EvolutionStellarToken consensus.
package types
...
// Header represents a block header in the EvolutionStellarToken blockchain.
type Header struct {
...
// Block represents an entire block in the EvolutionStellarToken blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package est to track
...
// [deprecated by est/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for est protocol, etc.
...
// DecodeRLP decodes the EvolutionStellarToken
...
// EncodeRLP serializes b into the EvolutionStellarToken RLP block format.

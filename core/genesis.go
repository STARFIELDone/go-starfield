...
func SetupGenesisBlock(db estdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) ToBlock(db estdb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db estdb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db estdb.Database) *types.Block {
...
func GenesisBlockForTesting(db estdb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{Alloc: GenesisAlloc{addr: {Balance: balance}}}
	return g.MustCommit(db)
}

// DefaultGenesisBlock returns the EvolutionStellarToken main net genesis block.
...
// DeveloperGenesisBlock returns the 'gest --dev' genesis block.

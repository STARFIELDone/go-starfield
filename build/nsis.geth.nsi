...
# 1. install gest for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gest
# 5. create gest, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable EvolutionStellarToken_SOCKET
...
!define GROUPNAME "EvolutionStellarToken"
!define APPNAME "Gest"
!define DESCRIPTION "Official Go implementation of the EvolutionStellarToken protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gest is installed global

...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/EvolutionStellarToken/go-EvolutionStellarToken/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of go-EvolutionStellarToken authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-EvolutionStellarToken Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-EvolutionStellarToken"
	}
	if startOfSentence {
		return "The go-EvolutionStellarToken library"
	}
	return "the go-EvolutionStellarToken library"
}

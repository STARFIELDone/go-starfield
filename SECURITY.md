...
Audit reports are published in the `docs` folder: https://github.com/EvolutionStellarToken/go-EvolutionStellarToken/tree/master/docs/audits 


| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `gest` | 20170425 | [pdf](https://github.com/EvolutionStellarToken/go-EvolutionStellarToken/blob/master/docs/audits/2017-04-25_Geth-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/EvolutionStellarToken/go-EvolutionStellarToken/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |
...
To find out how to disclose a vulnerability in EvolutionStellarToken visit [https://bounty.EvolutionStellarToken.org](https://bounty.EvolutionStellarToken.org) or email bounty@EvolutionStellarToken.org.

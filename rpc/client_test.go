...
// This test reproduces https://github.com/EvolutionStellarToken/go-EvolutionStellarToken/issues/17837 where the
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-EvolutionStellarToken-test-ipc-%d-%d", os.Getpid(), rand.Int63())

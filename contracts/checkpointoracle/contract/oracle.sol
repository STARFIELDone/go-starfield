 ...
 * @author Gary Rong<garyrong@EvolutionStellarToken.org>, Martin Swende <martin.swende@EvolutionStellarToken.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the EvolutionStellarToken.
    uint sectionSize;

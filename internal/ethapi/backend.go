...
// Package ethapi implements the general EvolutionStellarToken API functions.
package ethapi
...
type Backend interface {
	// General EvolutionStellarToken API
	...
	return []rpc.API{
		{
			Namespace: "est",
			Version:   "1.0",
			Service:   NewPublicEvolutionStellarTokenAPI(apiBackend),
			Public:    true,
		}, {
			Namespace: "est",
			Version:   "1.0",

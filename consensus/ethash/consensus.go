...
var (
	...
	// Specification EIP-2384: https://eips.EvolutionStellarToken.org/EIPS/eip-2384
	...
	// bomb offset 5M.
	// Specification EIP-1234: https://eips.EvolutionStellarToken.org/EIPS/eip-1234
	calcDifficultyConstantinople = makeDifficultyCalculator(big.NewInt(5000000))

	// calcDifficultyByzantium is the difficulty adjustment algorithm. It returns
	// the difficulty that a new block should have when created at time given the
	// parent block's time and difficulty. The calculation uses the Byzantium rules.
	// Specification EIP-649: https://eips.EvolutionStellarToken.org/EIPS/eip-649
...
// stock EvolutionStellarToken ethash engine.
...
// rules of the stock EvolutionStellarToken ethash engine.
...
func makeDifficultyCalculator(bombDelay *big.Int) func(time uint64, parent *types.Header) *big.Int {
	...
	return func(time uint64, parent *types.Header) *big.Int {
		// https://github.com/EvolutionStellarToken/EIPs/issues/100.
		// algorithm:
		// diff = (parent_diff +
		...
		// Specification: https://eips.EvolutionStellarToken.org/EIPS/eip-1234
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/EvolutionStellarToken/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +

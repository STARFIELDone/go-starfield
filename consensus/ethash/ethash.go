...
// all blocks' seal as valid, though they still have to conform to the EvolutionStellarToken
// consensus rules.
...
// still have to conform to the EvolutionStellarToken consensus rules.
...
// they still have to conform to the EvolutionStellarToken consensus rules.
...
func (ethash *Ethash) APIs(chain consensus.ChainHeaderReader) []rpc.API {
	...
	// to both est and ethash namespaces.
	return []rpc.API{
		{
			Namespace: "est",
			Version:   "1.0",

...
// Package consensus implements different EvolutionStellarToken consensus engines.
package consensus
...
type Engine interface {
	// Author retrieves the EvolutionStellarToken address of the account that minted the given

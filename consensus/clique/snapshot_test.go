...
// mapped from textual names used in the tests below to actual EvolutionStellarToken private
...
// address retrieves the EvolutionStellarToken address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the EvolutionStellarToken address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/EvolutionStellarToken/go-EvolutionStellarToken/issues/17593). Whilst this

...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db estdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db estdb.Database) error {

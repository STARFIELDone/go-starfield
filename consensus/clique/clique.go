...
// ecrecover extracts the EvolutionStellarToken account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the EvolutionStellarToken address
...
// EvolutionStellarToken testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     estdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // EvolutionStellarToken address of the signing key
...
func New(config *params.CliqueConfig, db estdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the EvolutionStellarToken address recovered

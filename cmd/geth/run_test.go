...
import (
	...
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/internal/cmdtest"
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/rpc"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "gest-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "gest-test" in runGeth.
	reexec.Register("gest-test", func() {
...
// spawns gest with the given command line args. If the args don't set --datadir, the
...
func runGeth(t *testing.T, args ...string) *testgeth {
	...
	// Boot "gest". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("gest-test", args...)

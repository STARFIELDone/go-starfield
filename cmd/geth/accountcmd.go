...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage EvolutionStellarToken presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gest wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import EvolutionStellarToken presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	gest wallet [options] /path/to/my/presale.wallet
...
between EvolutionStellarToken nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gest account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gest account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another EvolutionStellarToken instance,

...
// Package utils contains internal helper functions for go-EvolutionStellarToken commands.
package utils
...
import (
	...
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/accounts/keystore"
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/common"
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/common/fdlimit"
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/consensus"
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/consensus/clique"
	...
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/graphql"
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/internal/ethapi"
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/internal/flags"
	...
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/metrics/exp"
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/metrics/influxdb"
	...
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/p2p/discv5"
	...
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/p2p/netutil"
...
var (
	...
	NetworkIdFlag = cli.Uint64Flag{
		...
		Value: est.DefaultConfig.NetworkId,
	}
	...
	defaultSyncMode = est.DefaultConfig.SyncMode
	...
	LightServeFlag = cli.IntFlag{
		...
		Value: est.DefaultConfig.LightServ,
	}
	LightIngressFlag = cli.IntFlag{
		Name:  "light.ingress",
		Usage: "Incoming bandwidth limit for serving light clients (kilobytes/sec, 0 = unlimited)",
		Value: est.DefaultConfig.LightIngress,
	}
	LightEgressFlag = cli.IntFlag{
		Name:  "light.egress",
		Usage: "Outgoing bandwidth limit for serving light clients (kilobytes/sec, 0 = unlimited)",
		Value: est.DefaultConfig.LightEgress,
	}
	LightMaxPeersFlag = cli.IntFlag{
		Name:  "light.maxpeers",
		Usage: "Maximum number of light clients to serve, or light servers to attach to",
		Value: est.DefaultConfig.LightPeers,
	}
	UltraLightServersFlag = cli.StringFlag{
		Name:  "ulc.servers",
		Usage: "List of trusted ultra-light servers",
		Value: strings.Join(est.DefaultConfig.UltraLightServers, ","),
	}
	UltraLightFractionFlag = cli.IntFlag{
		Name:  "ulc.fraction",
		Usage: "Minimum % of trusted ultra-light servers required to announce a new head",
		Value: est.DefaultConfig.UltraLightFraction,
	}
	...
	EthashCachesInMemoryFlag = cli.IntFlag{
		...
		Value: est.DefaultConfig.Ethash.CachesInMem,
	}
	EthashCachesOnDiskFlag = cli.IntFlag{
		Name:  "ethash.cachesondisk",
		Usage: "Number of recent ethash caches to keep on disk (16MB each)",
		Value: est.DefaultConfig.Ethash.CachesOnDisk,
	}
	...
	EthashDatasetDirFlag = DirectoryFlag{
		...
		Value: DirectoryString(est.DefaultConfig.Ethash.DatasetDir),
	}
	EthashDatasetsInMemoryFlag = cli.IntFlag{
		Name:  "ethash.dagsinmem",
		Usage: "Number of recent ethash mining DAGs to keep in memory (1+GB each)",
		Value: est.DefaultConfig.Ethash.DatasetsInMem,
	}
	EthashDatasetsOnDiskFlag = cli.IntFlag{
		Name:  "ethash.dagsondisk",
		Usage: "Number of recent ethash mining DAGs to keep on disk (1+GB each)",
		Value: est.DefaultConfig.Ethash.DatasetsOnDisk,
	}
	...
	TxPoolPriceLimitFlag = cli.Uint64Flag{
		...
		Value: est.DefaultConfig.TxPool.PriceLimit,
	}
	TxPoolPriceBumpFlag = cli.Uint64Flag{
		Name:  "txpool.pricebump",
		Usage: "Price bump percentage to replace an already existing transaction",
		Value: est.DefaultConfig.TxPool.PriceBump,
	}
	TxPoolAccountSlotsFlag = cli.Uint64Flag{
		Name:  "txpool.accountslots",
		Usage: "Minimum number of executable transaction slots guaranteed per account",
		Value: est.DefaultConfig.TxPool.AccountSlots,
	}
	TxPoolGlobalSlotsFlag = cli.Uint64Flag{
		Name:  "txpool.globalslots",
		Usage: "Maximum number of executable transaction slots for all accounts",
		Value: est.DefaultConfig.TxPool.GlobalSlots,
	}
	TxPoolAccountQueueFlag = cli.Uint64Flag{
		Name:  "txpool.accountqueue",
		Usage: "Maximum number of non-executable transaction slots permitted per account",
		Value: est.DefaultConfig.TxPool.AccountQueue,
	}
	TxPoolGlobalQueueFlag = cli.Uint64Flag{
		Name:  "txpool.globalqueue",
		Usage: "Maximum number of non-executable transaction slots for all accounts",
		Value: est.DefaultConfig.TxPool.GlobalQueue,
	}
	TxPoolLifetimeFlag = cli.DurationFlag{
		Name:  "txpool.lifetime",
		Usage: "Maximum amount of time non-executable transaction are queued",
		Value: est.DefaultConfig.TxPool.Lifetime,
	}
	...
	CacheTrieJournalFlag = cli.StringFlag{
		...
		Value: est.DefaultConfig.TrieCleanCacheJournal,
	}
	CacheTrieRejournalFlag = cli.DurationFlag{
		Name:  "cache.trie.rejournal",
		Usage: "Time interval to regenerate the trie cache journal",
		Value: est.DefaultConfig.TrieCleanCacheRejournal,
	}
	...
	MinerGasTargetFlag = cli.Uint64Flag{
		...
		Value: est.DefaultConfig.Miner.GasFloor,
	}
	MinerGasLimitFlag = cli.Uint64Flag{
		Name:  "miner.gaslimit",
		Usage: "Target gas ceiling for mined blocks",
		Value: est.DefaultConfig.Miner.GasCeil,
	}
	MinerGasPriceFlag = BigFlag{
		Name:  "miner.gasprice",
		Usage: "Minimum gas price for mining a transaction",
		Value: est.DefaultConfig.Miner.GasPrice,
	}
	...
	MinerRecommitIntervalFlag = cli.DurationFlag{
		...
		Value: est.DefaultConfig.Miner.Recommit,
	}
	...
	RPCGlobalGasCapFlag = cli.Uint64Flag{
		...
		Value: est.DefaultConfig.RPCGasCap,
	}
	RPCGlobalTxFeeCapFlag = cli.Float64Flag{
		Name:  "rpc.txfeecap",
		Usage: "Sets a cap on transaction fee (in ether) that can be sent via the RPC APIs (0 = no cap)",
		Value: est.DefaultConfig.RPCTxFeeCap,
	}
	// Logging and debug settings
	EthStatsURLFlag = cli.StringFlag{
		Name:  "eststats",
		Usage: "Reporting URL of a eststats service (nodename:secret@host:port)",
	}
	...
	GpoBlocksFlag = cli.IntFlag{
		...
		Value: est.DefaultConfig.GPO.Blocks,
	}
	GpoPercentileFlag = cli.IntFlag{
		Name:  "gpo.percentile",
		Usage: "Suggested gas price is the given percentile of a set of recent transaction gas prices",
		Value: est.DefaultConfig.GPO.Percentile,
	}
	GpoMaxGasPriceFlag = cli.Int64Flag{
		Name:  "gpo.maxprice",
		Usage: "Maximum gas price will be recommended by gpo",
		Value: est.DefaultConfig.GPO.MaxPrice.Int64(),
	}
...
func MakeDataDir(ctx *cli.Context) string {
	if path := ctx.GlobalString(DataDirFlag.Name); path != "" {
		if ctx.GlobalBool(LegacyTestnetFlag.Name) || ctx.GlobalBool(RopstenFlag.Name) {
			// Maintain compatibility with older Gest configurations storing the
...
func setLes(ctx *cli.Context, cfg *est.Config) {
	...
	if cfg.UltraLightFraction <= 0 && cfg.UltraLightFraction > 100 {
		log.Error("Ultra light fraction is invalid", "had", cfg.UltraLightFraction, "updated", est.DefaultConfig.UltraLightFraction)
		cfg.UltraLightFraction = est.DefaultConfig.UltraLightFraction
	}
...
// for Gest and returns half of the allowance to assign to the database.
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `gest account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func setEtherbase(ctx *cli.Context, ks *keystore.KeyStore, cfg *est.Config) {
...
func SetP2PConfig(ctx *cli.Context, cfg *p2p.Config) {
	...
	log.Info("Maximum peer count", "est", ethPeers, "LES", lightPeers, "total", cfg.MaxPeers)
...
func setGPO(ctx *cli.Context, cfg *gasprice.Config, light bool) {
	...
	if light {
		cfg.Blocks = est.DefaultLightGPOConfig.Blocks
		cfg.Percentile = est.DefaultLightGPOConfig.Percentile
	}
...
func setEthash(ctx *cli.Context, cfg *est.Config) {
...
func setWhitelist(ctx *cli.Context, cfg *est.Config) {
...
func SetShhConfig(ctx *cli.Context, stack *node.Node) {
	if ctx.GlobalIsSet(WhisperEnabledFlag.Name) ||
		...
		log.Warn("Whisper support has been deprecated and the code has been moved to github.com/EvolutionStellarToken/whisper")
	}
}

// SetEthConfig applies est-related command line flags to the config.
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *est.Config) {
...
// no URLs are set.
func SetDNSDiscoveryDefaults(cfg *est.Config, genesis common.Hash) {
...
// RegisterEthService adds an EvolutionStellarToken client to the stack.
func RegisterEthService(stack *node.Node, cfg *est.Config) ethapi.Backend {
	if cfg.SyncMode == downloader.LightSync {
		backend, err := les.New(stack, cfg)
		if err != nil {
			Fatalf("Failed to register the EvolutionStellarToken service: %v", err)
		}
		return backend.ApiBackend
	} else {
		backend, err := est.New(stack, cfg)
		if err != nil {
			Fatalf("Failed to register the EvolutionStellarToken service: %v", err)
		}
		if cfg.LightServ > 0 {
...
// RegisterEthStatsService configures the EvolutionStellarToken Stats daemon and adds it to
// the given node.
func RegisterEthStatsService(stack *node.Node, backend ethapi.Backend, url string) {
	if err := eststats.New(stack, backend, backend.Engine(), url); err != nil {
		Fatalf("Failed to register the EvolutionStellarToken Stats service: %v", err)
	}
}
...
func SetupMetrics(ctx *cli.Context) {
	if metrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "gest.", tagsMap)
		}
...
func MakeChainDatabase(ctx *cli.Context, stack *node.Node) estdb.Database {
	var (
		cache   = ctx.GlobalInt(CacheFlag.Name) * ctx.GlobalInt(CacheDatabaseFlag.Name) / 100
		handles = makeDatabaseHandles()

		err     error
		chainDb estdb.Database
	)
...
func MakeChain(ctx *cli.Context, stack *node.Node, readOnly bool) (chain *core.BlockChain, chainDb estdb.Database) {
	var err error
	chainDb = MakeChainDatabase(ctx, stack)
	...
	if config.Clique != nil {
		...
		if !ctx.GlobalBool(FakePoWFlag.Name) {
			engine = ethash.New(ethash.Config{
				CacheDir:         stack.ResolvePath(est.DefaultConfig.Ethash.CacheDir),
				CachesInMem:      est.DefaultConfig.Ethash.CachesInMem,
				CachesOnDisk:     est.DefaultConfig.Ethash.CachesOnDisk,
				CachesLockMmap:   est.DefaultConfig.Ethash.CachesLockMmap,
				DatasetDir:       stack.ResolvePath(est.DefaultConfig.Ethash.DatasetDir),
				DatasetsInMem:    est.DefaultConfig.Ethash.DatasetsInMem,
				DatasetsOnDisk:   est.DefaultConfig.Ethash.DatasetsOnDisk,
				DatasetsLockMmap: est.DefaultConfig.Ethash.DatasetsLockMmap,
			}, nil, false)
		}
	}
	if gcmode := ctx.GlobalString(GCModeFlag.Name); gcmode != "full" && gcmode != "archive" {
	...
	cache := &core.CacheConfig{
		TrieCleanLimit:      est.DefaultConfig.TrieCleanCache,
		TrieCleanNoPrefetch: ctx.GlobalBool(CacheNoPrefetchFlag.Name),
		TrieDirtyLimit:      est.DefaultConfig.TrieDirtyCache,
		TrieDirtyDisabled:   ctx.GlobalString(GCModeFlag.Name) == "archive",
		TrieTimeLimit:       est.DefaultConfig.TrieTimeout,
		SnapshotLimit:       est.DefaultConfig.SnapshotCache,
	}
	if !ctx.GlobalIsSet(SnapshotFlag.Name) {
...
// new format.
//
// e.g. gest account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// gest --keystore /tmp/mykeystore --lightkdf account new
//

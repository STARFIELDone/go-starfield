...
// setting up a new or managing an existing EvolutionStellarToken private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your EvolutionStellarToken private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new EvolutionStellarToken network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and eststats servers |")
	...
	log.Info("Administering EvolutionStellarToken network", "name", w.network)

...
import (
	...
	math2 "github.com/EvolutionStellarToken/go-EvolutionStellarToken/common/math"
...
// C++ EvolutionStellarToken implementation.
...
// newAlethGenesisSpec converts a go-EvolutionStellarToken genesis block into a Aleth-specific
// chain specification format.
func newAlethGenesisSpec(network string, genesis *core.Genesis) (*alethGenesisSpec, error) {
	// Only ethash is currently supported between go-EvolutionStellarToken and aleth
...
type parityChainSpec struct {
	...
	Genesis struct {
		Seal struct {
			EvolutionStellarToken struct {
				Nonce   types.BlockNonce `json:"nonce"`
				MixHash hexutil.Bytes    `json:"mixHash"`
			} `json:"EvolutionStellarToken"`
		} `json:"seal"`
...
type parityChainSpecPricing struct {
	...
	// Before the https://github.com/paritytech/parity-EvolutionStellarToken/pull/11039,
...
// newParityChainSpec converts a go-EvolutionStellarToken genesis block into a Parity specific
// chain specification format.
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	// Only ethash is currently supported between go-EvolutionStellarToken and Parity
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	...
	// https://github.com/EvolutionStellarToken/EIPs/blob/master/EIPS/eip-608.md
	spec.Params.EIP150Transition = hexutil.Uint64(genesis.Config.EIP150Block.Uint64())

	// Spurious Dragon: 155, 160, 161, 170
	// https://github.com/EvolutionStellarToken/EIPs/blob/master/EIPS/eip-607.md
	...
	// gest has it set from zero
	spec.Params.MaxCodeSizeTransition = 0

	// Disable this one
	spec.Params.EIP98Transition = math.MaxInt64

	spec.Genesis.Seal.EvolutionStellarToken.Nonce = types.EncodeNonce(genesis.Nonce)
	spec.Genesis.Seal.EvolutionStellarToken.MixHash = (genesis.Mixhash[:])
	spec.Genesis.Difficulty = (*hexutil.Big)(genesis.Difficulty)
	spec.Genesis.Author = genesis.Coinbase
	spec.Genesis.Timestamp = (hexutil.Uint64)(genesis.Timestamp)
	spec.Genesis.ParentHash = genesis.ParentHash
...
// pyEvolutionStellarTokenGenesisSpec represents the genesis specification format used by the
// Python EvolutionStellarToken implementation.
type pyEvolutionStellarTokenGenesisSpec struct {
	Nonce      types.BlockNonce  `json:"nonce"`
	Timestamp  hexutil.Uint64    `json:"timestamp"`
	ExtraData  hexutil.Bytes     `json:"extraData"`
	GasLimit   hexutil.Uint64    `json:"gasLimit"`
...
// newPyEvolutionStellarTokenGenesisSpec converts a go-EvolutionStellarToken genesis block into a Parity specific
// chain specification format.
func newPyEvolutionStellarTokenGenesisSpec(network string, genesis *core.Genesis) (*pyEvolutionStellarTokenGenesisSpec, error) {
	// Only ethash is currently supported between go-EvolutionStellarToken and pyEvolutionStellarToken
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	spec := &pyEvolutionStellarTokenGenesisSpec{

...
// importGenesis imports a Gest genesis spec into puppeth.
...
func (w *wizard) manageGenesis() {
	...
	case "2":
		...
		// Export the native genesis spec used by puppeth and Gest
		...
		// Export the genesis spec used by Aleth (formerly C++ EvolutionStellarToken)
		...
		// Export the genesis spec used by Harmony (formerly EvolutionStellarTokenJ)

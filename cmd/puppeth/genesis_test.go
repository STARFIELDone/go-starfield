...
// Tests the go-EvolutionStellarToken to Aleth chainspec conversion for the Stureby testnet.
...
// Tests the go-EvolutionStellarToken to Parity chainspec conversion for the Stureby testnet.

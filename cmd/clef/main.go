...
import (
	...
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/signer/core"
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/signer/fourbyte"
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/signer/rules"
	"github.com/EvolutionStellarToken/go-EvolutionStellarToken/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage EvolutionStellarToken account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,

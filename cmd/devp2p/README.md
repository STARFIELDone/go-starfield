...
Use `devp2p enrdump <base64>` to verify and display an EvolutionStellarToken Node Record.
...
### est Protocol Test Suite

The est Protocol test suite is a conformance test suite for the [est protocol][est].

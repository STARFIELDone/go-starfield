...
func (s *spongeDb) NewBatch() estdb.Batch                    { return &spongeBatch{s} }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) estdb.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w estdb.KeyValueWriter) error { return nil }

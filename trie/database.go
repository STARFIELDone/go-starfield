...
type Database struct {
	diskdb estdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb estdb.KeyValueStore) *Database {
...
func NewDatabaseWithCache(diskdb estdb.KeyValueStore, cache int, journal string) *Database {
...
func (db *Database) DiskDB() estdb.KeyValueStore {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch estdb.Batch, uncacher *cleaner, callback func(common.Hash)) error {

...
// Verify that Client implements the EvolutionStellarToken interfaces.
var (
	_ = EvolutionStellarToken.ChainReader(&Client{})
	_ = EvolutionStellarToken.TransactionReader(&Client{})
	_ = EvolutionStellarToken.ChainStateReader(&Client{})
	_ = EvolutionStellarToken.ChainSyncReader(&Client{})
	_ = EvolutionStellarToken.ContractCaller(&Client{})
	_ = EvolutionStellarToken.GasEstimator(&Client{})
	_ = EvolutionStellarToken.GasPricer(&Client{})
	_ = EvolutionStellarToken.LogFilterer(&Client{})
	_ = EvolutionStellarToken.PendingStateReader(&Client{})
	// _ = EvolutionStellarToken.PendingStateEventer(&Client{})
	_ = EvolutionStellarToken.PendingContractCaller(&Client{})
)
...
func TestToFilterArg(t *testing.T) {
	...
	for _, testCase := range []struct {
		name   string
		input  EvolutionStellarToken.FilterQuery
		output interface{}
		err    error
	}{
		{
			"without BlockHash",
			EvolutionStellarToken.FilterQuery{
				Addresses: addresses,
...
func newTestBackend(t *testing.T) (*node.Node, []*types.Block) {
	...
	// Create EvolutionStellarToken Service
	config := &est.Config{Genesis: genesis}
	config.Ethash.PowMode = ethash.ModeFake
	ethservice, err := est.New(n, config)
	if err != nil {
		t.Fatalf("can't create new EvolutionStellarToken service: %v", err)
	}

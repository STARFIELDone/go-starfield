...
func TestNewUnpacker(t *testing.T) {
	...
	testcases := []unpackTest{
		...
		}, { // https://github.com/EvolutionStellarToken/wiki/wiki/EvolutionStellarToken-Contract-ABI#examples
...
[
	...
	for i, hexdata := range []string{
		...
		// From https://github.com/EvolutionStellarToken/wiki/wiki/EvolutionStellarToken-Contract-ABI
